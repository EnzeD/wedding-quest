...
import { createManoir, createGrange, createCottage, createAnnexe } from "./buildings.ts";
import {
...
function createPond(scene: THREE.Scene, x: number, z: number, rx: number, rz: number): PondData {
...
function createPath(scene: THREE.Scene, points: [number, number][], width: number): void {
...
function createGravelArea(scene: THREE.Scene, x: number, z: number, w: number, d: number): void {
...
function createHills(scene: THREE.Scene): void {
